...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.NONE,
		classes = { KafkaAvroProducerApplication.class, BaseClass.TestConfig.class })
...
class BaseClass {
	...
	@Container
	static ConfluentKafkaContainer kafka = new ConfluentKafkaContainer(DockerImageName.parse("confluentinc/cp-kafka"));
	...
	static class TestConfig {
		...
		ContractVerifierObjectMapper contractVerifierObjectMapper() {
			var json = JsonMapper.builder().addMixIn(SpecificRecordBase.class, AvroIgnoreMixin.class).build();
